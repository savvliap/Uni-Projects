...
syms x1 x2 x3
assume(x3,'real')
g1=collect(vpa(discriminant([x1 x2 x3]',mean1',cov1,prior)))
g2=collect(vpa(discriminant([x1 x2 x3]',mean2',cov2,prior)))
boundary1=collect(solve(g1==g2,x1))
boundary2=collect(solve(g1==g2,x2))
boundary3=collect(solve(g1==g2,x3))
...
for i=1:length(char)
    g(i,1)=discriminant(char(i,1:3)',mean1',cov1,prior);
    g(i,2)=discriminant(char(i,1:3)',mean2',cov2,prior);
