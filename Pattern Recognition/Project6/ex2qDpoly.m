...
polymodel1=fitcsvm(train1(:,1:3), train1(:,4), 'KernelFunction', 'polynomial');
svm_3d_plot(polymodel1,data1(:,1:3),data1(:,4)); title('setosa vs all'); hold on;
...
polymodel2=fitcsvm(train2(:,1:3), train2(:,4), 'KernelFunction', 'polynomial');
svm_3d_plot(polymodel2,data2(:,1:3),data2(:,4)); title('vercicolor vs all'); hold on;
...
polymodel3=fitcsvm(train3(:,1:3), train3(:,4), 'KernelFunction', 'polynomial');
svm_3d_plot(polymodel3,data3(:,1:3),data3(:,4));title('virginica vs all'); hold on;
