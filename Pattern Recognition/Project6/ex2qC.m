...
linmodel1=fitcsvm(train1(:,1:4), train1(:,5), 'KernelFunction', 'linear');
...
linmodel2=fitcsvm(train2(:,1:4), train2(:,5), 'KernelFunction', 'linear');
...
linmodel3=fitcsvm(train3(:,1:4), train3(:,5), 'KernelFunction', 'linear');
