...
############# TODO0 ###############
# Set the path
test_rgb = "lab6/test_rgb"  # Path to the test_rgb folder
test_thermal = "lab6/test_thermal"  # Path to the test_thermal folder
###################################
...
for i in range(200, 300):  # you can change the range up to 518
    ...
    if FUSION == "EARLY":
        ...
        new_fus = None
        new_fus[:, :, :2]=img_rgb[:, :, :2]
        new_fus[:, :, :-1]=np.maximum(img_rgb[:, :, :-1], img_thermal[:, :, :-1])
